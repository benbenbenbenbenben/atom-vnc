  ...
  class VncView {
    ...
    updateRectangle(rect) {
      ...
      return this.drawable.addEventListener('mousewheel', (function(_this) {
        return function(event) {
          var delta, offset, x, y, offsetleft, offsettop;
          offsetleft = _this.drawable.offsetLeft;
          offsettop = _this.drawable.offsetTop;
    ...
    content() {
      ...
      <canvas id="vnc-view" outlet='drawable'>
